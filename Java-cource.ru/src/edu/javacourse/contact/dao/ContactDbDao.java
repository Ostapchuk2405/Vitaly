...
public class ContactDbDao implements ContactDAO {
	...
	private static final String SELECT = "SELECT contact_id, first_name, last_name, phone, email FROM jc_contact ORDER BY first_name, last_name";
	private static final String SELECT_ONE = "SELECT contact_id, first_name, last_name, phone, email FROM jc_contact WHERE contact_id=?";
	private static final String INSERT = "INSERT INTO jc_contact (first_name, last_name, phone, email) VALUES(?, ?, ?, ?)";
	private static final String UPDATE = "UPDATE jc_contact SET first_name=?, last_name=?, phone=?, email=? WHERE contact_id=?";
