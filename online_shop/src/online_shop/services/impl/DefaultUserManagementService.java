...
import online_shop.storage.impl.DefaultUserStoringService;
...
public class DefaultUserManagementService implements UserManagementService {
	...
	public String registerUser(User user) {
		...
		String errorMesssage = checkUniqueEmail(user.getEmail());
		if (errorMesssage != null && !errorMesssage.isEmpty()) {
